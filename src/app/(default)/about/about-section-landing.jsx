...
export default function AboutSectionLanding({ sectionType }) {
  return (
    ...
    >
      ...
      leveraging technology and open data to address civic challenges and enhance public services in
      the Fresno area. Our community thrives on collaboration, innovation, and a shared commitment
