 ...
 *
 */
export default function SingleProjectsResources({ data, sectionType = SectionType.light }) {
  if (data.meta.resources) {
    return <ProjectInformationSection obj={data.meta.resources} sectionType={sectionType} />;
  } else {
    return (
      <PageContainer sectionType={sectionType}>
        ...
        <p className="project-paragraph">
          Explore our resources section on the project page to discover a wealth of design assets,
          tutorials, and tools that will inspire and empower your creative journey.
        </p>
          ...
          if (data.meta.resources.tutorials) {
            ...
            return data.meta.resources.tutorials.map((link) => (
              <>
                <hr className="project-info-line" />
                <div className="project-info-container">
                  <p className="project-info-label">Tutorial {tutorialCounter++}</p>
        ...
        <div>
          <div className="project-info-container">
            ...
            <p className="project-info-text">{data.meta.resources.meeting_times}</p>
            <p className="project-info-label">Office Hours</p>
            <p className="project-info-text">{data.meta.resources.office_hours}</p>
          </div>
        </div>
        <hr className="project-info-line" />
      </PageContainer>
