    ...
    <section id="how-to-volunteer" className="project-volunteer-container">
      <div className="project-volunteer-info-container">
        ...
        <p className="project-paragraph">
          Join us at Open Fresno to collaborate on impactful civic tech projects and connect with a
          diverse community of like-minded individuals. It&apos;s a rewarding way to make a
