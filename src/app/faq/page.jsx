    ...
    return (
        <Layout>
            <div className="faq-main">
                ...
                <section
                    className={`faq-container app-color--${SectionType.light} py-6 px-6`}
                >
                    <nav
                ...
                <section
                    className="faq-container-margins mx-auto flex max-w-[calc(var(--screen-xxl)+80px)] flex-col gap-0 px-6 py-t lg:pt-12 lg:pb-17">
