...
/**
 * Renders page content alongside a fixed sidebar of volunteer and resource links.
 * @param {object} props - Component props.
 * @param {React.ReactNode} props.children - Main section content.
 * @param {string} props.sectionType - Theme variant for the sidebar callout.
 * @returns {React.JSX.Element} The content and sidebar layout.
 */
  ...
  return (
    <section className="sidebar-section-container">
      ...
      <div className="flex flex-col gap-10 lg:w-[411px] lg:shrink-0">
        <div>
          <Blurb src={rectangleBlue} alt="rectangle" float="right">
