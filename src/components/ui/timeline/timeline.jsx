"use client";
import { SimpleButton, TimelineItem } from "./timeline-item.jsx";
import React, { useCallback, useEffect, useRef, useState } from "react";

/**
 * Renders the volunteer-opportunity timeline and updates its scroll animation geometry.
 * @param {object} props - Component props.
 * @param {string} [props.className=""] - Classes applied to the timeline root.
 * @returns {React.JSX.Element} The responsive opportunities timeline.
 */
